...
typedef struct YaatCommand { YaatCommandKind kind; char a[96]; char b[96]; int bool_value; int first_child; int child_count; int first_else_child; int else_child_count; } YaatCommand;
