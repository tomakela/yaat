...
function drawBmp(path,x,y,w,h){ const im=img(path); if(imageLoaded(im)) ctx.drawImage(im,x,y,w||im.naturalWidth,h||im.naturalHeight); else if(im.failed) rect(x,y,w||24,h||24,hashColor(path,0x2f5f9e)); }
